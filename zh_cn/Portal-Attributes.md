...
#### 是否在实体传送后调整实体位置{#Whether to Adjust The Entity's Position After Teleporting}
...
![](https://qouteall.fun/imm_ptl_wiki_copy/assets/2020-12-19-14-06-20.png)

NBT tag: `fuseView`

#### 渲染可合并{#Rendering Mergable}
