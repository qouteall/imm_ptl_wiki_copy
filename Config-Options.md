...
![](https://qouteall.fun/imm_ptl_wiki_copy/assets/Untitled3.png)

Turning down the max portal layer can save your FPS.

![](https://qouteall.fun/imm_ptl_wiki_copy/assets/Untitled4.png)

If it's 0, you can see the portal view area but the world inside the portal won't be rendered.

![](https://qouteall.fun/imm_ptl_wiki_copy/assets/2020-08-26_15.09.41.png)
...
![](https://qouteall.fun/imm_ptl_wiki_copy/assets/2021-01-06-21-39-35.png)
